...
public class Symbols {
	...
	public static String whiteCastle = String.valueOf("\u2656".toCharArray());
	public static String whiteKnight = String.valueOf("\u2658".toCharArray());
	public static String warning = String.valueOf('\u26A0');
	public static String blackDiamond = String.valueOf('\u2756');
	public static String asterisk1 = String.valueOf('\u25BA');
	public static String asterisk2 = String.valueOf('\u2630');
	public static String asterisk3 = String.valueOf('\u2732');
	public static String snowflake = String.valueOf('\u273B');
	public static String topLeft = String.valueOf('\u256D');
	public static String topRight = String.valueOf('\u256E');
	public static String bottomLeft = String.valueOf('\u2570');
